...
var CORE_APP_ROOT = path.join(REPO_ROOT, "apps/trenchclaw");
...
var HEALTH_TIMEOUT_MS = Number.parseInt(process.env.RELEASE_HEALTH_TIMEOUT_MS || "30000", 10);
...
var waitForRuntimeHealth = async (runtimeUrl, timeoutMs) => {
