...
Generated at: 2026-03-23T00:19:29.423Z
...
| `src/ai/brain/knowledge/geckoterminal-api-docs.md` | Geckoterminal Api Docs | guide | read-second | the task matches this topic and the smaller reference docs do not fully answer it |
...
| `src/ai/brain/knowledge/jupiter-ai-docs.md` | Jupiter AI Docs + API Quick Ops | guide | read-second | Jupiter AI docs discovery, MCP setup, markdown export, or shell-first Jupiter API workflows |
