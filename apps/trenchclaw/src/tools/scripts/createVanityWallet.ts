...
Usage:
  bun run src/tools/scripts/createVanityWallet.ts --starts-with <prefix> [options]
  bun run src/tools/scripts/createVanityWallet.ts --ends-with <suffix> [options]
  bun run src/tools/scripts/createVanityWallet.ts --starts-and-ends-with <prefix> <suffix> [options]
