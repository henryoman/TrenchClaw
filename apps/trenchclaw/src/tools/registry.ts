...
const runtimeActionToolDefinitionsBase: readonly RuntimeActionToolDefinitionWithoutReadiness[] = [
  ...
  },
  {
    ...
    purpose: "Expose the smallest useful balance read when the model already knows one exact address and should not escalate to heavier wallet inventory tools.",
    routingHint: "the user gave one exact address and you only need its current SOL balance",
