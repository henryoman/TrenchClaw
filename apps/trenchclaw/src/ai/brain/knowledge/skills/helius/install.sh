...
usage() {
  ...
  echo ""
  echo "Install the Helius skill into .agents/skills."
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  ./install.sh              # Install to ~/.agents/skills/helius/"
  echo "  ./install.sh --project    # Install to ./.agents/skills/helius/"
