...
const OPERATOR_GROUP_MATCHERS: Record<ToolGroupId, RegExp> = {
  ...
  "market-news": /\b(news|headline|headlines|sentiment|trend|trending|market|markets|token|tokens|coin|coins|pair|pairs|dex|dexscreener|launch|price|prices|boost|boosts|meme|memes|whale|whales|holder|holders)\b/iu,
