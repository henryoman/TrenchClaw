...
import { renderKnowledgeManifestMarkdown } from "../../ai/brain/knowledge/knowledge-tree";
...
export const refreshKnowledgeManifest = async (): Promise<string[]> => {
  ...
  const markdown = await renderKnowledgeManifestMarkdown(KNOWLEDGE_DIR, generatedAt);
