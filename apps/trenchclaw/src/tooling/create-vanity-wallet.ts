...
Usage:
  bun run src/tooling/create-vanity-wallet.ts --starts-with <prefix> [options]
  bun run src/tooling/create-vanity-wallet.ts --ends-with <suffix> [options]
  bun run src/tooling/create-vanity-wallet.ts --starts-and-ends-with <prefix> <suffix> [options]
