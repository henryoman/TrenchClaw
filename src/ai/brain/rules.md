...
- Keep event names aligned with `src/ai/runtime/types/events.ts`: `action:start`, `action:success`, `action:fail`, `action:retry`, `bot:start`, `bot:pause`, `bot:stop`, `policy:block`, `rpc:failover`.
