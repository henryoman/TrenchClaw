...
import { DEV_INSTANCE_CLONE_PARTS, cloneDeveloperInstance, type DevInstanceClonePart } from "./lib/devRuntime";
...
const printHelp = (): void => {
  console.log(
    [
      "Usage: bun run scripts/devInstanceClone.ts --from-root <path> --to-root <path> [options]",
      "",
      "Options:",
