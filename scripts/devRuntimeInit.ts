...
import { getDefaultDeveloperRuntimeRoots, initializeDeveloperRuntime } from "./lib/devRuntime";
...
const printHelp = (): void => {
  console.log(
    [
      "Usage: bun run scripts/devRuntimeInit.ts [options]",
      "",
      "Options:",
      ...
      "  --instance <id>           Two-digit instance id (default: 00)",
      "  --instance-name <name>    Instance display name (default: default for 00, otherwise instance-<id>)",
