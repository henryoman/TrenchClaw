import { resolveHostPlatformTarget } from "./releasePlatform";
...
export const RELEASE_BUILD_COMMANDS = {
  bundle: "bun run scripts/buildApp.ts",
  verify: "bun run scripts/verifyAppBundle.ts",
  package: "bun run scripts/packageAppRelease.ts",
  smoke: "bun run scripts/smokeTestRelease.ts",
} as const;
