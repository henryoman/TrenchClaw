...
<p align="center">
  <a href="./package.json"><img src="https://img.shields.io/badge/Version-0.0.0--beta.3-2563EB?style=for-the-badge" alt="Version 0.0.0-beta.3" /></a>
...
```bash
# local verification
bun run release:build -- --version v0.0.0-beta.3 --run-checks

# review the release body that will be published
# releases/0.0.0-beta.3.md
```
...
- prerelease versions like `0.0.0-beta.3` should stay on `manual` mode until you intentionally cut a stable line
